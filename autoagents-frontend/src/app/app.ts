    ...
    this.http
      ...
      .subscribe({
        ...
        error: (error: unknown) => {
          ...
          this.workspaceMermaidSaveMessage.set(`Failed to generate diagram: ${errorMessage}. Please check your API keys and try again.`);
          
          // Show error in chat as well
          this.appendMessage({
            sender: 'assistant',
            agent: 'agent2',
            text: `Agent 3 could not generate the diagram. ${errorMessage}. Please check your Claude API key configuration.`,
            runId: null,
          });
        },
      });
